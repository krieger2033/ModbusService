...
namespace NModbus.IO
{
    ...
    internal class ModbusIpTransport : ModbusTransport
    {
        ...
        internal virtual byte[] ReadRequestResponse(IStreamResource streamResource, IModbusLogger logger)
        {
            if (streamResource == null) throw new ArgumentNullException(nameof(streamResource));
        ...
        internal virtual byte[] GetMbapHeader(IModbusMessage message)
        {
